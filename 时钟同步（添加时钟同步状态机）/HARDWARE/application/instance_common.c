...
int instance_init(void)
{
    ...
    instance_data[instance].instToSleep = FALSE;
		instance_data[instance].CurrentState_Syc = TA_INIT ;
...
//		if(instance_data[instance].msg_f.messageData[2] == 0x5A )
//		{
//			n = sprintf((char*)&LogBuff[0], "T1= %d\r\n",OS_TS_GET());
//			USB_TxWrite(LogBuff, n);
//			instance_data[instance].msg_f.messageData[2] = 0;
//		}
	}
...
//			n = sprintf((char*)&LogBuff[0], "SA\r\n");
//			n += sprintf((char*)&LogBuff[n], "%02x\r\n",sourceAddress);
//			USB_TxWrite(LogBuff, n);
